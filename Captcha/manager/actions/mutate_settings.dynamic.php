...
// Captcha settings moved to new tab.
...
<?php echo get_lang_options(null, $fe_editor_lang);?>
	  ...
	  <?php
// Edited by DWand. 05.02.2012. Replacing captcha.
// New tab for captcha settings.
	  ?>
      <!-- Captcha settings -->
      <div class="tab-page" id="tabPage8">
        <h2 class="tab"><?php echo "Captcha"; ?></h2>
		...
		<table border="0" cellspacing="0" cellpadding="3">
		  ...
		  <tr>
			  <td><b><?php echo $_lang["captcha_image_width"]?></b></td>
			  <td>
			  <input type="text" name="captcha_image_width" onchange="documentDirty=true;" value="<?php echo isset($captcha_image_width) ? $captcha_image_width : "215"; ?>" />
			  </td>
		  </tr>
		  <tr>
				<td width="200">&nbsp;</td>
				<td class='comment'><?php echo $_lang["captcha_image_width_message"]?></td>
		  </tr>
		  <tr>
				<td colspan="2"><div class='split'></div></td>
		  </tr>
		  ...
		  <tr>
			  <td><b><?php echo $_lang["captcha_image_height"]?></b></td>
			  <td>
			  <input type="text" name="captcha_image_height" onchange="documentDirty=true;" value="<?php echo isset($captcha_image_height) ? $captcha_image_height : "80"; ?>" />
			  </td>
		  </tr>
		  <tr>
				<td width="200">&nbsp;</td>
				<td class='comment'><?php echo $_lang["captcha_image_height_message"]?></td>
		  </tr>
		  <tr>
				<td colspan="2"><div class='split'></div></td>
		  </tr>
		  ...
		  <tr>
			  <td><b><?php echo $_lang["captcha_image_type"]?></b></td>
			  <td>
			  <select name="captcha_image_type">
				  <option value="1"<?php echo (isset($captcha_image_type) && $captcha_image_type == 1) ? 'selected="selected"' : ""; ?>>JPEG</option>
				  <option value="2"<?php echo (isset($captcha_image_type) && $captcha_image_type == 2) ? 'selected="selected"' : ""; ?>>PNG</option>
				  <option value="3"<?php echo (isset($captcha_image_type) && $captcha_image_type == 3) ? 'selected="selected"' : ""; ?>>GIF</option>
			  </select>
			  </td>
		  </tr>
		  <tr>
				<td width="200">&nbsp;</td>
				<td class='comment'><?php echo $_lang["captcha_image_type_message"]?></td>
		  </tr>
		  <tr>
				<td colspan="2"><div class='split'></div></td>
		  </tr>
		  ...
		  <tr>
			  <td><b><?php echo $_lang["captcha_image_bg_color"]?></b></td>
			  <td>
			  <input type="text" name="captcha_image_bg_color" onchange="documentDirty=true;" value="<?php echo isset($captcha_image_bg_color) ? $captcha_image_bg_color : "#ffffff"; ?>" />
			  </td>
		  </tr>
		  <tr>
				<td width="200">&nbsp;</td>
				<td class='comment'><?php echo $_lang["captcha_image_bg_color_message"]?></td>
		  </tr>
		  <tr>
				<td colspan="2"><div class='split'></div></td>
			  </tr>
		  ...
		  <tr>
			  <td><b><?php echo $_lang["captcha_text_color"]?></b></td>
			  <td>
			  <input type="text" name="captcha_text_color" onchange="documentDirty=true;" value="<?php echo isset($captcha_text_color) ? $captcha_text_color : "#707070"; ?>" />
			  </td>
		  </tr>
		  <tr>
				<td width="200">&nbsp;</td>
				<td class='comment'><?php echo $_lang["captcha_text_color_message"]?></td>
		  </tr>
		  <tr>
				<td colspan="2"><div class='split'></div></td>
		  </tr>
		  ...
		  <tr>
			  <td><b><?php echo $_lang["captcha_line_color"]?></b></td>
			  <td>
			  <input type="text" name="captcha_line_color" onchange="documentDirty=true;" value="<?php echo isset($captcha_line_color) ? $captcha_line_color : "#707070"; ?>" />
			  </td>
		  </tr>
		  <tr>
				<td width="200">&nbsp;</td>
				<td class='comment'><?php echo $_lang["captcha_line_color_message"]?></td>
		  </tr>
		  <tr>
				<td colspan="2"><div class='split'></div></td>
			  </tr>
		  ...
		  <tr>
			  <td><b><?php echo $_lang["captcha_noise_color"]?></b></td>
			  <td>
			  <input type="text" name="captcha_noise_color" onchange="documentDirty=true;" value="<?php echo isset($captcha_noise_color) ? $captcha_noise_color : "#707070"; ?>" />
			  </td>
		  </tr>
		  <tr>
				<td width="200">&nbsp;</td>
				<td class='comment'><?php echo $_lang["captcha_noise_color_message"]?></td>
		  </tr>
		  <tr>
				<td colspan="2"><div class='split'></div></td>
			  </tr>
		  ...
		  <tr>
			  <td><b><?php echo $_lang["captcha_text_transparency_percentage"]?></b></td>
			  <td>
			  <input type="text" name="captcha_text_transparency_percentage" maxlength="3" onchange="documentDirty=true;" value="<?php echo isset($captcha_text_transparency_percentage) ? $captcha_text_transparency_percentage : "50"; ?>" />
			  </td>
		  </tr>
		  <tr>
				<td width="200">&nbsp;</td>
				<td class='comment'><?php echo $_lang["captcha_text_transparency_percentage_message"]?></td>
		  </tr>
		  <tr>
				<td colspan="2"><div class='split'></div></td>
			  </tr>
		  ...
		  <tr>
			  <td><b><?php echo $_lang["captcha_use_transparent_text"]?></b></td>
			  <td>
			  <input type="radio" name="captcha_use_transparent_text" value="1" onchange="documentDirty=true;" <?php echo ((isset($captcha_use_transparent_text) && $captcha_use_transparent_text == 1) || !isset($captcha_use_transparent_text)) ? 'checked="checked" ' : "";?>/><?php echo $_lang["yes"]?><br />
			  <input type="radio" name="captcha_use_transparent_text" value="0" onchange="documentDirty=true;" <?php echo (isset($captcha_use_transparent_text) && $captcha_use_transparent_text == 0) ? 'checked="checked" ' : ""; ?>/><?php echo $_lang["no"]?>		  
			  </td>
		  </tr>
		  <tr>
				<td width="200">&nbsp;</td>
				<td class='comment'><?php echo $_lang["captcha_use_transparent_text_message"]?></td>
		  </tr>
		  <tr>
				<td colspan="2"><div class='split'></div></td>
			  </tr>
		  ...
		  <tr>
			  <td><b><?php echo $_lang["captcha_code_length"]?></b></td>
			  <td>
			  <input type="text" name="captcha_code_length" onchange="documentDirty=true;" value="<?php echo isset($captcha_code_length) ? $captcha_code_length : "6"; ?>" />
			  </td>
		  </tr>
		  <tr>
				<td width="200">&nbsp;</td>
				<td class='comment'><?php echo $_lang["captcha_code_length_message"]?></td>
		  </tr>
		  <tr>
				<td colspan="2"><div class='split'></div></td>
		  </tr>
		  ...
		  <tr>
			  <td><b><?php echo $_lang["captcha_case_sensitive"]?></b></td>
			  <td>
			  <input type="radio" name="captcha_case_sensitive" value="1" onchange="documentDirty=true;" <?php echo ((isset($captcha_case_sensitive) && $captcha_case_sensitive == 1) || !isset($captcha_case_sensitive)) ? 'checked="checked" ' : "";?>/><?php echo $_lang["yes"]?><br />
			  <input type="radio" name="captcha_case_sensitive" value="0" onchange="documentDirty=true;" <?php echo (isset($captcha_case_sensitive) && $captcha_case_sensitive == 0) ? 'checked="checked" ' : ""; ?>/><?php echo $_lang["no"]?>		  
			  </td>
		  </tr>
		  <tr>
				<td width="200">&nbsp;</td>
				<td class='comment'><?php echo $_lang["captcha_case_sensitive_message"]?></td>
		  </tr>
		  <tr>
				<td colspan="2"><div class='split'></div></td>
			  </tr>
		  ...
		  <tr>
			  <td><b><?php echo $_lang["captcha_charset"]?></b></td>
			  <td>
			  <input type="text" name="captcha_charset" onchange="documentDirty=true;" value="<?php echo isset($captcha_charset) ? $captcha_charset : "ABCDEFGHKLMNPRSTUVWYZabcdefghklmnprstuvwyz23456789"; ?>" />
			  </td>
		  </tr>
		  <tr>
				<td width="200">&nbsp;</td>
				<td class='comment'><?php echo $_lang["captcha_charset_message"]?></td>
		  </tr>
		  <tr>
				<td colspan="2"><div class='split'></div></td>
		  </tr>
		  ...
		  <tr>
			  <td><b><?php echo $_lang["captcha_perturbation"]?></b></td>
			  <td>
			  <input type="text" name="captcha_perturbation" onchange="documentDirty=true;" value="<?php echo isset($captcha_perturbation) ? $captcha_perturbation : "0.75"; ?>" />
			  </td>
		  </tr>
		  <tr>
				<td width="200">&nbsp;</td>
				<td class='comment'><?php echo $_lang["captcha_perturbation_message"]?></td>
		  </tr>
		  <tr>
				<td colspan="2"><div class='split'></div></td>
		  </tr>
		  ...
		  <tr>
			  <td><b><?php echo $_lang["captcha_num_lines"]?></b></td>
			  <td>
			  <input type="text" name="captcha_num_lines" onchange="documentDirty=true;" value="<?php echo isset($captcha_num_lines) ? $captcha_num_lines : "8"; ?>" />
			  </td>
		  </tr>
		  <tr>
				<td width="200">&nbsp;</td>
				<td class='comment'><?php echo $_lang["captcha_num_lines_message"]?></td>
		  </tr>
		  <tr>
				<td colspan="2"><div class='split'></div></td>
		  </tr>
		  ...
		  <tr>
			  <td><b><?php echo $_lang["captcha_noise_level"]?></b></td>
			  <td>
			  <input type="text" name="captcha_noise_level" onchange="documentDirty=true;" value="<?php echo isset($captcha_noise_level) ? $captcha_noise_level : "0"; ?>" />
			  </td>
		  </tr>
		  <tr>
				<td width="200">&nbsp;</td>
				<td class='comment'><?php echo $_lang["captcha_noise_level_message"]?></td>
		  </tr>
		  <tr>
				<td colspan="2"><div class='split'></div></td>
		  </tr>
		  ...
		  <tr>
			  <td><b><?php echo $_lang["captcha_image_signature"]?></b></td>
			  <td>
			  <input type="text" name="captcha_image_signature" onchange="documentDirty=true;" value="<?php echo isset($captcha_image_signature) ? $captcha_image_signature : ""; ?>" />
			  </td>
		  </tr>
		  <tr>
				<td width="200">&nbsp;</td>
				<td class='comment'><?php echo $_lang["captcha_image_signature_message"]?></td>
		  </tr>
		  <tr>
				<td colspan="2"><div class='split'></div></td>
		  </tr>
		  ...
		  <tr>
			  <td><b><?php echo $_lang["captcha_signature_color"]?></b></td>
			  <td>
			  <input type="text" name="captcha_signature_color" onchange="documentDirty=true;" value="<?php echo isset($captcha_signature_color) ? $captcha_signature_color : "#707070"; ?>" />
			  </td>
		  </tr>
		  <tr>
				<td width="200">&nbsp;</td>
				<td class='comment'><?php echo $_lang["captcha_signature_color_message"]?></td>
		  </tr>
		  <tr>
				<td colspan="2"><div class='split'></div></td>
		  </tr>
		  ...
		  <tr>
			  <td><b><?php echo $_lang["captcha_type"]?></b></td>
			  <td>
			  <select name="captcha_type">
				  <option value="0" <?php echo (isset($captcha_type) && $captcha_type == 0) ? 'selected="selected" ' : ""; ?>><?php echo $_lang["captcha_type_string"]?></option>
				  <option value="1" <?php echo (isset($captcha_type) && $captcha_type == 1) ? 'selected="selected" ' : ""; ?>><?php echo $_lang["captcha_type_mathematic"]?></option>
			  </select>
			  </td>
		  </tr>
		  <tr>
				<td width="200">&nbsp;</td>
				<td class='comment'><?php echo $_lang["captcha_type_message"]?></td>
		  </tr>
		</table>
      </div><?php /* DWand. 05.02.2012. Replacing captcha. End of changes. */?>
